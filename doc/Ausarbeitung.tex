...
%\begin{description}[font=\normalfont]
    ...
    Mit dieser Methode fügt man dem Dokument eine neue Anzeigebox für den Algorithmus mit Namen \texttt{algoName} hinzu und speichert für ihn eine Farbe ab, in der die Annotations angezeigt werden.
    \subparagraph{\texttt{setAlgoBox(algoName)}} 
